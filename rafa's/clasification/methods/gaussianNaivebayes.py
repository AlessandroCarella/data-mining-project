...
#set wd
os.chdir("clasification/methods")

#load ds normalized
df = pd.read_csv("../dataset (missing + split)/R_Norm_Prueba_Dataset_nomissing_nofeatur_noutlier.csv", skip_blank_lines=True)

#load ds normalized and logtransformed
#df = pd.read_csv("../dataset (missing + split)/R_Log_Norm_Prueba_Dataset_nomissing_nofeatur_noutlier.csv", skip_blank_lines=True)

#load only log transformed data
#df = pd.read_csv("../dataset (missing + split)/R_Log_Prueba_Dataset_nomissing_nofeatur_noutlier.csv", skip_blank_lines=True)
